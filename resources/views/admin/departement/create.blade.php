...
<h1>Ajouter un nouvel  departement</h1>
<!-- BEGIN SAMPLE FORM PORTLET-->
        <div class="portlet box purple ">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('departement.store') }}">
                	{{ csrf_field() }}
                    <div class="form-body">
                        <div class="form-group">
                            <label class="col-md-3 control-label">Libelle departement</label>
                            <div class="col-md-9">
