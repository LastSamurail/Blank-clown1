...
<!-- BEGIN SAMPLE FORM PORTLET-->
        <div class="portlet box purple ">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('utilisateur.store') }}">
                	{{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            {!!$errors->first('departement','<span class="help-block m-b-none text-danger">:message</span>')!!}
                        </div>
